  ...
  memset(lpVersionInformation, 0, sizeof(OS_VERSION_INFO));
    ...
    if (lpGetVersionEx)
    {
      ...
      if (bGotOSviEx)
      {
        ...
        strcpy_s(lpVersionInformation->szEmulatedCSDVersion, osviex.szCSDVersion);
        ...
        strcpy_s(lpVersionInformation->szUnderlyingCSDVersion, lpVersionInformation->szEmulatedCSDVersion);
      ...
      else
      {
        ...
        strcpy_s(lpVersionInformation->szEmulatedCSDVersion, osvi.szCSDVersion);
        ...
        if (osvi.dwPlatformId == VER_PLATFORM_WIN32s)  //32 bit app running on Windows 3.x
        {
          ...
          strcpy_s(lpVersionInformation->szUnderlyingCSDVersion, _T(""));
        }
        else
        {
          lpVersionInformation->dwUnderlyingMajorVersion = lpVersionInformation->dwEmulatedMajorVersion; 
